<script lang="ts">
	...
	const kind = $derived(
		(() => {
			...
			if (normalized === 'window' || normalized === 'window-closed' || normalized === 'window-closed-variant') return 'window';
			...
			if (normalized === 'router-wireless' || normalized === 'server-network' || normalized === 'access-point') return 'router';
			...
			if (normalized === 'floor-lamp-outline' || normalized === 'floor-lamp' || normalized === 'lamp-outline' || normalized === 'lamp') return 'floor_lamp';
