...
<button type="button" class="modal-overlay picker-overlay" onclick={onClose} aria-label={t('closeOverlay')}
></button>
<div
	class="settings-modal app-popup picker-modal"
	role="dialog"
	aria-modal="true"
	aria-label={title}
				...
				<div class="picker-row">
					...
					{:else}
						...
						<button
							type="button"
							class="edit-btn"
							aria-label={t('Naam aanpassen')}
							onclick={() => openRename(entity)}
