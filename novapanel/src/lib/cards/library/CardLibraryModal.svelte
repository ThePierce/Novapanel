<script lang="ts">
	...
	const cardTypeStyling = getCardTypeStyling;
</script>

<button
	type="button"
	class="modal-overlay card-library-overlay"
	onclick={onClose}
	aria-label={t('closeOverlay')}
></button>
<div
	class="settings-modal app-popup card-library-modal np-detail"
	role="dialog"
	aria-modal="true"
				...
				<div class="card-library-controls">
					...
					{#if renameSectionOpen && activeSection}
						<div class="library-section-rename">
							...
							<button
								type="button"
								class="library-section-rename-save"
							...
							<button
								type="button"
								class="library-section-rename-cancel"
								onclick={() => (renameSectionOpen = false)}
								aria-label={t('cancel')}
							>
					...
					<div class="library-tile-preview">
						...
						{:else if entry.preview.kind === 'divider'}
							...
							>
								...
								<rect
									...
									height="2"
									rx="1"
									fill={`url(#np-divider-line-${entry.id})`}
								/>
						...
						{:else if entry.preview.kind === 'weather'}
							...
							>
								...
								<text
									...
									font-weight="700"
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial">21°</text
								>
								<text
									x="44"
									y="106"
									...
									font-family="Inter, system-ui, Arial">{t('weather_partlycloudy')}</text
								>
							...
							>
								...
								{#each [0, 1, 2, 3, 4] as i (i)}
									<text
										...
										font-weight="600"
										fill="rgba(245,245,245,0.9)"
										font-family="Inter, system-ui, Arial">{t('weekdayShortMon')}</text
									>
									<text
										x={44 + i * 52}
										y="106"
										...
										font-weight="700"
										fill="#f5f5f5"
										font-family="Inter, system-ui, Arial">18°</text
									>
								{/each}
							</svg>
						{:else if entry.preview.kind === 'week_calendar'}
							...
							>
								...
								<text
									...
									font-weight="700"
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial">12</text
								>
								<text
									x="124"
									y="78"
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Weekkalender')}</text
								>
								<text
									x="124"
									y="96"
									...
									font-family="Inter, system-ui, Arial">3 {t('events')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'alarm_panel'}
							...
							>
								...
								<circle
									...
									cy="85"
									r="28"
									fill="rgba(225,82,65,0.12)"
									stroke="rgba(225,82,65,0.35)"
									stroke-width="1.5"
								/>
								<path
									d="M80 68 C80 68 95 73 95 82 C95 93 87 100 80 103 C73 100 65 93 65 82 C65 73 80 68 80 68Z"
									fill="none"
									stroke="#e15241"
									stroke-width="2.2"
								...
								<text
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Alarmpaneel')}</text
								>
								<text
									x="124"
									y="96"
									...
									font-weight="600"
									fill="#e15241"
									font-family="Inter, system-ui, Arial">{t('Ingeschakeld')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'lights_status'}
							...
							>
								...
								<text
									...
									font-weight="700"
									fill="#1b2433"
									font-family="Inter, system-ui, Arial">3</text
								>
								<text
									x="124"
									y="78"
								...
								<text
									...
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">3 {t('aan')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'light_button'}
							...
							>
								...
								<rect x="74" y="94" width="12" height="5" rx="2.5" fill="#ffd338" opacity="0.6" />
								<path
									d="M58 64 L52 58 M102 64 L108 58 M58 96 L52 102 M102 96 L108 102 M80 50 L80 44 M80 110 L80 116"
									stroke="#ffd338"
									stroke-width="1.6"
									stroke-linecap="round"
									opacity="0.55"
								...
								<text
									...
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">{t('Aan')} · 68%</text
								>
							</svg>
						{:else if entry.preview.kind === 'device_button'}
							...
							>
								...
								<rect
									...
									height="22"
									rx="7"
									fill={`url(#np-device-plug-${entry.id})`}
									opacity="0.94"
								/>
								<line
									x1="74"
								...
								/>
								<path
									d="M80 92 V108 Q80 116 70 116 H62"
									fill="none"
									stroke="#34d399"
									stroke-width="3"
									stroke-linecap="round"
								...
								<text
									...
									font-weight="700"
									fill="#06261c"
									font-family="Inter, system-ui, Arial">1</text
								>
								<text
									x="124"
									y="78"
								...
								<text
									...
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">{t('Aan')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'climate_button'}
							...
							>
								...
								<path
									d="M61 104 A 25 25 0 1 1 99 104"
									fill="none"
									stroke={`url(#np-climate-dial-${entry.id})`}
									stroke-width="3.5"
									stroke-linecap="round"
								/>
								<text
								...
								<text
									...
									font-family="Inter, system-ui, Arial">→ 22°</text
								>
								<text
									x="124"
									y="78"
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Thermostaat')}</text
								>
								<text
									x="124"
									y="96"
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">{t('Verwarmen')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'cover_button'}
							...
							>
								...
								<path
									d="M55 63 Q57 75 55 88 Q57 100 55 110 L70 110 Q72 100 70 88 Q72 75 70 63 Z"
									fill={`url(#np-curtain-left-${entry.id})`}
									opacity="0.92"
								/>
								...
								<path
									d="M90 63 Q88 75 90 88 Q88 100 90 110 L105 110 Q107 100 105 88 Q107 75 105 63 Z"
									fill={`url(#np-curtain-right-${entry.id})`}
									opacity="0.92"
								/>
								...
								<text
									...
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">66% {t('open')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'vacuum_button'}
							...
							>
								...
								<path
									d="M50 110 Q65 60 80 110 Q95 60 110 110"
									fill="none"
								...
								<text
									...
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">{t('Schoonmaken')} · 82%</text
								>
							</svg>
						{:else if entry.preview.kind === 'media_player_button'}
							...
							>
								...
								<rect
									...
									height="54"
									rx="11"
									fill={`url(#np-speaker-body-${entry.id})`}
									opacity="0.95"
								/>
								...
								<text
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Media player')}</text
								>
								<text
									x="124"
									y="96"
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">{t('Speelt muziek')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'openings_status'}
							...
							>
								...
								<text
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Ramen/Deuren')}</text
								>
								<text
									x="140"
									y="96"
									...
									font-weight="700"
									fill="#60a5fa"
									font-family="Inter, system-ui, Arial">2</text
								>
								<text
									x="158"
									y="96"
						...
						{:else if entry.preview.kind === 'devices_status'}
							...
							>
								...
								<text
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Apparatenstatus')}</text
								>
								<text
									x="140"
									y="96"
									...
									font-weight="700"
									fill="#a78bfa"
									font-family="Inter, system-ui, Arial">5</text
								>
								<text
									x="158"
									y="96"
						...
						{:else if entry.preview.kind === 'availability_status'}
							...
							>
								...
								<text
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Bereikbaarheid')}</text
								>
								<text
									x="140"
									y="96"
									...
									font-weight="600"
									fill="#4ade80"
									font-family="Inter, system-ui, Arial">{t('Alles bereikbaar')}</text
								>
							</svg>
						{:else if entry.preview.kind === 'media_players_status'}
							...
							>
								...
								<circle
									...
									cy="85"
									r="28"
									fill="rgba(79,113,168,0.15)"
									stroke="rgba(79,113,168,0.4)"
									stroke-width="1.5"
								/>
								...
								<text
									...
									fill="#f5f5f5"
									font-family="Inter, system-ui, Arial"
									opacity="0.9">{t('Media Spelers')}</text
								>
								<text
									x="140"
									y="96"
									...
									font-family="Inter, system-ui, Arial">Music Assistant</text
								>
							</svg>
						{:else if entry.preview.kind === 'energy'}
							...
							>
								...
								<text
									...
									font-family="Inter, system-ui, Arial">{t('Zonnepanelen')}</text
								>
								<text
									x="80"
									y="67"
									...
									font-weight="700"
									fill="#facc15"
									font-family="Inter, system-ui, Arial">2.4 kW</text
								>
								<circle
									cx="56"
									cy="103"
								...
								<text
									...
									font-weight="600"
									fill="rgba(245,245,245,0.7)"
									font-family="Inter, system-ui, Arial">{t('Thuisaccu')}</text
								>
								<text
									x="80"
									y="112"
									...
									font-weight="700"
									fill="#4ade80"
									font-family="Inter, system-ui, Arial">82%</text
								>
							</svg>
						{:else if entry.preview.kind === 'cameras_strip'}
							...
							>
								...
								<text
									...
									font-size="11"
									fill="rgba(245,245,245,0.5)"
									font-family="Inter, system-ui, Arial">3 live</text
								>
							</svg>
						{/if}
					</div>
...
<style>
	...
	.library-tile:hover {
		...
		box-shadow:
			...
			0 0 24px var(--tile-accent-soft, rgba(255, 255, 255, 0.1));
	}
	...
	.library-tile-glow {
		...
		width: 80%;
		height: 80%;
		background: radial-gradient(circle, var(--tile-accent-soft, rgba(255, 255, 255, 0.1)), transparent 70%);
		filter: blur(30px);
		pointer-events: none;
		z-index: 0;
		opacity: 0.6;
	...
	.library-tile:hover .library-tile-glow {
		opacity: 1;
	}
	...
	.library-tile:hover .preview-svg {
	...
	.library-tile:hover .library-tile-icon {
